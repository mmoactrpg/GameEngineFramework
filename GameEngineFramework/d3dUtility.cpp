...
//int d3d::RenderThread(LPVOID lpParameter)
//{
//	g_bIsInitialise = true;
//	g_hThread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)ListenThread, (void *)lpParameter, 0, &g_dwThreadID);
//}
//
//DWORD WINAPI d3d::ListenThread(LPVOID lpParameter)
//{
	...
	HWND* hwnd)
{
	...
	////HWND hwnd = 0;
	//*hwnd = ::CreateWindow("Direct3D9App", LPCSTR("Direct3D9App-程序"), 
	//	WS_EX_TOPMOST,
	//	0, 0, width, height,
	...
	//if( !hwnd )
	//{
	//	::MessageBox(0, LPCSTR("CreateWindow() - FAILED失败"), 0, 0);
	//	return false;
	//}
